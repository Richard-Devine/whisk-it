...
export default class Home extends React.Component <HomeProps> {
    ...
    newestProducts(product:object){

    }

    newestOffers(product:object) {
    ...
    render(){
        return(
            <div>
                ...
                <div data-testid='new-products-container' className='new-products-container' onClick={() => {this.props.onClick('ProductList')}}>
                    Our latest products!
