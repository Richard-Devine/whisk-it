...
export default class LandingPage extends React.Component {
    ...
    totalPrice() {
        ...
        if (this.state.myBasket.length > 0) {
            this.state.myBasket.map((product) => {
                total += product.price;
                return this.setState({basketTotal: total});
            });
        } else {
            total = 0;
        ...
        return (
            <div className="website-container">
                ...
                <Routes>
                    ...
                    <Route path="Products/*"
                           element={<ProductDetails id={this.state.productId} addProductButton={(x) => {
                               this.addToBasket(x)
                           }}/>}/>
                    ...
                    <Route path="Basket"
                           element={<Basket myBasket={this.state.myBasket} myBasketTotal={this.state.basketTotal}
                                            deleteItem={() => {
                                                this.totalPrice()
                                            }}/>}/>
                    <Route path="Checkout" element={<Checkout myBasket={this.state.myBasket}
