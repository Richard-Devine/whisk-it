    ...
    render(){
        return(
            <div data-testid='footer-wrapper' className='footer-wrapper'>
                <div data-testid='fotter-links' className='footer-links'>
                ...
                <div data-testid='footer-text' className='footer-text'>
                    <p>If you have any special requests or questions with any of our products please contact us via our instagram or email above. <br/>
                    We take pride and make our products to the highest quality, if you are unhappy with the quality of our products please do not hesitate to get in contact with us.</p>
                </div>
            </div>
        )
    }
