...
describe("basket tests", () => {
    ...
    it("render correct divs", () => {
        const wrapper = shallow(<Basket myBasket={[{id: "6", title: "Biscoff Blondie", imageURL: "www.somewhere.com/image3", price: 1300},
            {id: "6", title: "Milky Way Crispy Roll Blondie", imageURL: "www.somewhere.com/image3", price: 1300}]}  myBasketTotal={2600} deleteItem={() => null}/>)
    ...
    it("onClick functions work as expected", () => {
        ...
        const wrapper = mount(<Basket myBasket={[{id: "6", title: "Biscoff Blondie", imageURL: "www.somewhere.com/image3", price: 13},
            {id: "6", title: "Milky Way Crispy Roll Blondie", imageURL: "www.somewhere.com/image3", price: 13}]} myBasketTotal={10} deleteItem={mockFunc}/>)
    ...
    it("removeFromBasket function works as expected", () => {
        const wrapper = shallow(<Basket myBasketTotal={10} myBasket={[{id: "9", title: "Half and Half Box", imageURL: "www.somewhere.com/image3",  price: 1500, options:{1:"none selected", 2:"none selected"}},
